    ...
    function query($the_query, $bypass=0) {
        ...
        if ($bypass != 1)
        {
			if ($this->obj['sql_tbl_prefix'] != "ibf_")
			{
	           ...
	           $the_query = str_replace("ibf_members", $this->obj['sql_tbl_prefix']."users", $the_query);
	           $the_query = str_replace("ibf_emoticons", $this->obj['sql_tbl_prefix']."smiles", $the_query);
	           ...
	           $the_query = str_replace("m.location", "m.user_from", $the_query);
	           $the_query = str_replace("m.password", "m.pass", $the_query);
	           $the_query = str_replace("m.joined", "m.user_regdate", $the_query);
	           $the_query = str_replace("m.aim_name", "m.user_aim", $the_query);
	           $the_query = str_replace("m.icq_number", "m.user_icq", $the_query);
	           $the_query = str_replace("m.hide_email", "m.user_viewemail", $the_query);
	           $the_query = str_replace("m.msnname", "m.user_msnm", $the_query);
	           $the_query = str_replace("m.view_sigs", "m.attachsig", $the_query);
	           $the_query = str_replace("m.time_offset", "m.timezone_offset", $the_query);
        	}
        }
