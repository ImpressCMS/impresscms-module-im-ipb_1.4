...
class legends {
    ...
    function legends() {
 	...
 	function find_user_two()
 	{
 		...
 		$DB->query("SELECT uid, uname FROM ibf_members WHERE LOWER(uname) LIKE '".$ibforums->input['username']."%' LIMIT 0,101");
 	...
 	function show_emoticons()
 	{
 		...
 		$DB->query("SELECT code, smile_url from ibf_emoticons");
