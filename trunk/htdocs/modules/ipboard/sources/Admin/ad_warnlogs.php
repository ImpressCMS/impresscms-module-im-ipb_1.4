...
class ad_warnlogs {
	...
	function view_note()
	{
		...
		$DB->query("SELECT l.*, m.uid as a_id, m.uname as a_name, p.uid as p_id, p.uname as p_name
						FROM ibf_warn_logs l
						  LEFT JOIN ibf_members m ON (m.uid=l.wlog_mid)
	...
	function list_current()
	{
		...
		$DB->query("SELECT l.*, m.uname, count(l.wlog_mid) as act_count from ibf_warn_logs l, ibf_members m WHERE m.uid=l.wlog_mid GROUP BY l.wlog_mid ORDER BY act_count DESC");
