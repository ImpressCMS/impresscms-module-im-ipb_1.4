...
class ad_settings {
	...
	function list_sets()
	{
		...
		$DB->query("select ibf_skins.*, count(ibf_members.uid) as mcount from ibf_skins left join ibf_members on(ibf_members.skin=ibf_skins.sid) where (ibf_members.skin is not null or ibf_skins.default_set = 1) group by ibf_skins.sid order by ibf_skins.sname");
