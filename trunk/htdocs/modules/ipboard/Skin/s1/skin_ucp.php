...
<td align="center"><img src="../../uploads/avatars{$img}" border="0" alt="txt"><br /><input type="radio" class="radiobutton" name="avatar" value="$form" id="$form" />&nbsp;<strong><label for="$form">$txt</label></strong></td>
