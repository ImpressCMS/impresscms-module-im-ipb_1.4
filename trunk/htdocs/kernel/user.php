<?php
// $Id: user.php 507 2006-05-26 23:39:35Z skalpa $
/*
// ------------------------------------------------------------------------
-+ Date: 12-SEP-2006
...
class XoopsUser extends XoopsObject
{
    ...
    {
      	//<<<-------------------------------------------------------------
      	//-+- Add some fields for XOOPS's User Object
      	//<<<-------------------------------------------------------------    	
        $this->initVar('mgroup', XOBJ_DTYPE_INT, 3, false);
        $this->initVar('skin', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('view_pop', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('dst_in_use', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('last_activity', XOBJ_DTYPE_INT, 0, false);
        $this->initVar('last_visit', XOBJ_DTYPE_INT, 0, false);        
      	//<<<-------------------------------------------------------------    	
...
class XoopsUserHandler extends XoopsObjectHandler
{
	...
	global $isbb;
        ...
        if ($user->isNew()) {
			...
			//<<<--------------------------------------------
			//-+- IPB statistic update -- Koudanshi
			//<<<--------------------------------------------
			if ($isbb){
